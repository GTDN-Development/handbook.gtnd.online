---
title: "AGENTS.md"
description: "A reference file that defines coding standards, project structure, and best practices for your TypeScript/Next.js projects. Every project should have an `agents.md` file that defines the coding standards, project structure, and best practices for your TypeScript/Next.js projects."
highlight: true
---
