...
description: "Instead of writing a privacy policy from scratch, use the `GdprPolicy` component to generate a fully localized GDPR policy page. Pass your company details and the component handles the rest, with built-in translations for English and Czech."
highlight: true
---
...
<Steps>
    ...
    **Create your file**
    ```bash
    touch src/components/gdpr/gdpr-policy.tsx
    ```
    </Step>
    <Step>
    **Copy & paste the source code**
    ```tsx title="src/components/gdpr/gdpr-policy.tsx"
    type Locale = "cs" | "en";
    ...
    <Step>
    **Create the GDPR page**
    ```bash
    mkdir -p src/app/gdpr && touch src/app/gdpr/page.tsx
    ```
    </Step>
    <Step>
        **Copy & paste the code**
        ```tsx title="app/gdpr/page.tsx"
...
export default function Page() {
  return (
    <>
      ...
      <Step>
    Update Company Legal Information, GdprPolicy component is already prepared to render this information
